...
class TableHeader extends Component {
  ...
  render() {
    console.log("table header", this.props.selectedSite);
    ...
    return (
      <Grid
        ...
        // alignItems="center"
        style={{ backgroundColor: "#424B4D", height: "auto", width: "auto" }}
      >
        <Grid
          item
          container
          ...
          alignItems="baseline"
          style={{height: "auto", display: "flex", alignItems: "baseline", paddingLeft: 10, color: "white" }}
        >
