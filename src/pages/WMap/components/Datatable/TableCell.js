  ...
  useEffect(() => {
    if (ref.current) {
      ...
      var colorScale = d3
        ...
        .domain(["start", "driving", "parking", "lunch", "home", "DLV", "PRECEIPT", "PICK", "MISCPICK", "MISCDROP"]);
        ...
        .call(
          d3Timelines
            ...
            .tickFormat({
              ...
              format: (d) => moment.utc(d).tz('Africa/Monrovia').format("HH.mm"),
  ...
  const styles = {
    ...
    const ConvtMill2Hm = (i) => {
       ...
       console.log("inside convt",i);
        ...
        var hm = moment(d).tz('Africa/Monrovia').format('HH:mm');
