...
export default function PurchaseOrderManager({selectedOrder,setSelectedOrder,isCreate,setCreate,setLoader,trailerList, setTrailerList, filteredOrders, setFilteredOrders, error, setError, searchTerm, setSearchTerm }) {
  ...
  //   user: selectedOrder?.trailer.trim()?"This field is mandatory":"",
  //   site: selectedOrder?.fcy.trim()?"This field is mandatory":"",
  //   type: selectedOrder?.type.trim()?"This field is mandatory":"",
  //   style: selectedOrder?.styzon.trim()?"This field is mandatory":"",
  //   maxLength: selectedOrder?.maxLen>0?"This field is mandatory":"",
  //   maxWidth: selectedOrder?.maxWid.trim()?"This field is mandatory":"",
  //   crubWeight: selectedOrder?.curbWei.trim()?"This field is mandatory":"",
  //   maxLoadingMass: selectedOrder?.maxLoams.trim()?"This field is mandatory":"",
  //   maxFreightHeight: selectedOrder?.maxFH.trim()?"This field is mandatory":"",
  //   gvwr: selectedOrder?.gvwr.trim()?"This field is mandatory":"",
  //   maxLoadVol: selectedOrder?.maxLovol.trim()?"This field is mandatory":"",
  ...
  const LeftSide = (
    <Card className="h-100 m-0">
      ...
      <CardBody>
        ...
        >
          <Table hover striped style={{ marginBottom: 0, minWidth: "600px",minHeight:"500px" }}>
            <thead>
              <tr>
                {["Trailer", "Description", "Site", "Type", "Model"].map((header) => (
                  <th
                    key={header}
                    style={{
                      position: "sticky",
              ...
              {currentItems.map((order) => (
                <tr
                  ...
                  style={{
                    ...
                    backgroundColor: selectedOrder?.trailer === order?.trailer ? "lightblue" : "",
                  }}
                >
                  <td>{order.trailer}</td>
                  <td>{order.des}</td>
