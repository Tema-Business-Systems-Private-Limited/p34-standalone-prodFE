...
import PrereciptList from "./components/PrereciptList";
...
const SiteConfiguration = () => {
  ...
  const [prereciptList, setPrereciptList] = useState([]);
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  if (isCreate) {
                                    ...
                                    setSelectedOrder(newSiteClassObj);
                                    toast.success("Pre-receipt form cleared successfully!", {
                                      position: "top-right",
                                      autoClose: 3000,
                                    });
                          ...
                          <>
                            ...
                            <Tooltip title="Refresh">
                              <IconButton
                                ...
                                onClick={() => {
                                  setSelectedOrder(newSiteClassObj);
                                  toast.success("Pre-recipt form cleared successfully!", {
                                    position: "top-right",
                                    autoClose: 3000,
                                  });
                                }}
                      ...
                      <div className="flex justify-between items-center gap-4 mb-6">
                        <Select
                          ...
                          options={[
                            ...
                            ...prereciptList.map((site) => ({ value: site, label: site })),
                          ]}
                          value={
                            selectedSite
