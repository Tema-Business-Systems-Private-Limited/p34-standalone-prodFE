 ...
 <TabPane tabId="Pickups">
   <Row className="my-2">
            ...
            <div class="reportlist-view tableCustomFixHead">
                <table class= {"table table-sm "+ (this.props.trailerDropped ? " " : "table-striped m-0")}>
                    ...
                    <tbody>
                        ...
                        return (
                            ...
                            <tr id={'pickup' + pickup.docnum}
                                ...
                                style={{ backgroundColor: this.props.trailerDropped ? this.getBgcolor(pickup.trailer,pickup.docnum,pickup.type) :'' }}
                                onDragStart={(event) =>
