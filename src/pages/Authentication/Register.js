                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                ...
                                                <p className="text-muted">Get your  Route Planner account now.</p>
                                            </div>
                                                ...
                                                <AvForm onValidSubmit={this.handleSubmit} className="form-horizontal" >
                                                    ...
                                                    <FormGroup className="auth-form-group-custom mb-4">
                                                     ...
                                                     <FormGroup className="auth-form-group-custom mb-4">
                                                                                                            ...
                                                                                                            <AvField name="fname"  value={this.state.fname} type="text" className="form-control" id="fname" placeholder="Enter FirstName"/>
                                                                                                        </FormGroup>
                                                      <FormGroup className="auth-form-group-custom mb-4">
                                                                                                             <i className="ri-user-2-line auti-custom-input-icon"></i>
                                                                                                             <Label htmlFor="lname">Last Name</Label>
                                                                                                             <AvField name="lname"  value={this.state.lname} type="text" className="form-control" id="lname" placeholder="Enter LastName"/>
                                                                                                         </FormGroup>
                                                    ...
                                                    <div className="mt-4 text-center">
                                                        <p className="mb-0">By registering you agree to the TBS <Link to="#" className="text-primary">Terms of Use</Link></p>
                                                    </div>
                                                </AvForm>
                                            </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                ...
                                                <p>© 2020 TBS. Crafted with <i className="mdi mdi-heart text-danger"></i> by Tema Business Systems</p>
                                            </div>
                                        </div>
