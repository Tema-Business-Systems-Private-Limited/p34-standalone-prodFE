                ...
                <div class="middlesection">
                    <div class="reportlist-view2">
                        <form class="p-3 pt-1 floating-form row vehicle-formdtls">
                            <div class="col-md-6">
                                <h6 class="mb-3" style={{ fontWeight: 'bold',fontSize : '16px' }}>{this.props.t('TotalDrops')}</h6>
...
{this.props.t('Weight')}</label> <br />
                                                <p style={{ display: 'flex' }}>{nullAndNanChecking(parseFloat(tdropwei).toFixed(2), 'vrStops')}  {wu}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div className="floating-label">
...
{this.props.t('Cap_Vehicule_Masse')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ? nullAndNanChecking(parseFloat(VehicleCapacity).toFixed(2),'vrStops') : parseFloat(trip.capacities).toFixed(2)} {wu} </p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div className="floating-label">
...
{this.props.t('Volume_livraison')}</label> <br />
                                                <p style={{ display: 'flex' }}>{nullAndNanChecking(tdropvol, 'vrStops')} {vu}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div className="floating-label">
...
{this.props.t('Cap_Vehicule_Volume')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ? VehicleVolume : 0} {vu}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div className="floating-label">
...
{this.props.t('Chargement_Vol')}</label> <br />
                                ...
                                <h6 class="mb-3" style={{ fontWeight: 'bold',fontSize : "16px" }}>{this.props.t('TotalPickUps')}</h6>
                                   <hr style={{backgroundColor:'rgb(102,178,255)',height:'1px'}}></hr>
                                <div class="row no-gutters">
                                    <div class="col-md-12 row no-gutters">
                                        <div class="col-lg-4">
...
{this.props.t('PickupWeight')}</label> <br />
                                                <p style={{ display: 'flex' }}>{nullAndNanChecking(tpickupwei, 'vrStops')} {wu}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div className="floating-label">
...
{this.props.t('VehWeightAvail')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ? avai_weight : 0} {wu}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 row no-gutters">
...
{this.props.t('PickupVol')}</label> <br />
                                                <p style={{ display: 'flex' }}>{nullAndNanChecking(tpickupvol, 'vrStops')} {vu}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div className="floating-label">
...
{this.props.t('VehVolAvail')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ? avai_vol : 0} {vu}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <h6 class="mb-3" style={{ fontWeight: 'bold',fontSize : '16px' }}>Totals</h6>
                               <hr style={{backgroundColor:'rgb(102,178,255)',height:'1px'}}></hr>
                                <div class="row no-gutters">
...
{this.props.t('TotDistance')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ? parseFloat(this.props.vrdata.totdistance).toFixed(2) : nullAndNanChecking(trip.totalDistance)} {distunts}</p>
                                            </div>
                                        </div>
                                    </div>
...
{this.props.t('DistanceCost')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ?   parseFloat(trip.distanceCost).toFixed(2) : nullAndNanChecking(trip.distanceCost)} {currency}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{this.props.t('TotalTime')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ? parseFloat(this.props.vrdata.tottime).toFixed(2) : nullAndTime(trip.totalTime)} Hours</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7 row no-gutters">
...
{this.props.t('TravelTimeCost')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ?   parseFloat(trip.regularCost).toFixed(2) : nullAndNanChecking(trip.regularCost)}{currency}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7 row no-gutters">
...
{this.props.t('OverTimeCost')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ?  parseFloat(overtimecost).toFixed(2) : 0 }{currency}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div className="floating-label">
...
{this.props.t('TotalCost')}</label> <br />
                                                <p style={{ display: 'flex' }}>{trip.lock ? parseFloat(trip.totalCost).toFixed(2) : nullAndNanChecking(trip.totalCost)}{currency}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
