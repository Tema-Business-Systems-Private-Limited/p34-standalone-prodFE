    ...
    displayDropStatus = (vStatus, x, docnum) => {
       const dropStatus = vStatus
        ...
        if(dlvyStatus == '1') {
          return (
                          <h6>
                             <span class='badge badge-success text-uppercase'>{this.props.t('To Plan')}</span>
                          </h6>
                      );
        }
         if(dlvyStatus == '2') {
                  return (
                                  <h6>
                                    <span class='badge badge-primary text-uppercase'>{this.props.t('Planned')}</span>
                                  </h6>
                              );
                }
        if(dlvyStatus == '3') {
                  return (
                                  <h6>
                                     <span class='badge badge-warning text-uppercase'>{this.props.t('Loading InProgress')}</span>
                                  </h6>
                              );
                }
        if(dlvyStatus == '4') {
                          return (
                                          <h6>
                                             <span class='badge badge-danger text-uppercase'>{this.props.t('Loading Completed')}</span>
                                          </h6>
                                      );
                        }
        if(dlvyStatus == '5') {
                          return (
                                          <h6>
                                           <span class='badge badge-danger text-uppercase'>{this.props.t('Route in Progress')}</span>
                                          </h6>
                                      );
                        }
        if(dlvyStatus == '6') {
                                  return (
                                                  <h6>
                                                     <span class='badge badge-dark text-uppercase'>{this.props.t('Completed')}</span>
                                                  </h6>
                                              );
                                }
        if(dlvyStatus == '7') {
         ...
         if(dlvyStatus == '8') {
          ...
          if(dlvyStatus == '9') {
                                           return (
                                                           <h6>
                                                               <span class='badge badge-danger text-uppercase'>{this.props.t('Rescheduled')}</span>
                                                           </h6>
                                                       );
                                         }
           if(dlvyStatus == '10') {
                                            return (
                                                            <h6>
                                                                <span class='badge badge-danger text-uppercase'>{this.props.t('Validated')}</span>
                                                            </h6>
                                                        );
                                          }
           if(dlvyStatus == '11') {
                                                 return (
                                                                 <h6>
                                                                     <span class='badge badge-success text-uppercase'>{this.props.t('POD Completed')}</span>
                                                                 </h6>
                                                             );
                                               }
    }
                        ...
                        {(dropList || []).map((drops, i) => {
                            ...
                            return (
                                <tr id={'drops' + i}
                                    ...
                                    draggable={drops.type === 'open'  ? "true" : "true"}
