...
import AddTemplateForm from "./ExternalDragnDrop";
...
class ShiftAssignment extends Component {
  constructor(props) {
    super(props);
    this.state = {
      sites: [],
                ...
                <Col xs="12">
                  <Card>
                    <CardBody className="">
                      ...
                      <Row style={{ borderLeft: '2px solid blue',borderRight:'2px solid blue',borderBottom:'2px solid blue'}}>
                        <Col md="12">
                          <AddTemplateForm />
                        </Col>
                      </Row>
