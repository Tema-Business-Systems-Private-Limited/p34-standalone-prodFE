                  ...
                  <Row style={{ height: "60px" }} className="mb-4">
                    <Col md="6" className="d-flex align-items-center">
                      <CardTitle className="h1 mb-0 text-3xl font-bold">
                        {isCreate
                          ? "Create Miscellaneous Stop"
                          : editUser
                            ? "Update Miscellaneous Stop"
                            : "Miscellaneous Stop"}
                      </CardTitle>
                    </Col>
                    ...
                    <Col md="6" className="d-flex justify-content-end align-items-center h-100">
                      <Toolbar style={{ gap: "10px" }}>
                        ...
                        {!isCreate && !editUser && (
                          <>
                            <Tooltip title="Create miscellaneous stop">
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  if (isCreate) {
                                    ...
                                    setSelectedOrder(newSiteClassObj);
                                    toast.success("Miscellaneous Stop form cleared successfully!", {
                                      position: "top-right",
                                      autoClose: 3000,
                                    });
                      ...
                      <div className="flex justify-between items-center gap-4 mb-6">
                        <Select
                          ...
                          options={[
                            ...
                            ...stopList.map((site) => ({ value: site, label: site })),
                          ]}
                          value={
                            selectedSite
                        ...
                        <div className="relative" style={{ width: '600px' }}>
                          ...
                          <input
                            type="text"
                            placeholder="Search miscellaneous stop..."
                            value={searchTerm}
