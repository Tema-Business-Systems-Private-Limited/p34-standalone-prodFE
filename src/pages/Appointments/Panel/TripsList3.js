...
import { convertHrToSec, convertMinToSec, formatTime, nullAndNanChecking,tConvert, splitTime } from '../converterFunctions/converterFunctions';
                                ...
                                <tbody>
                                    {(this.props.tripsList && this.props.tripsList || []).map((trip, i) => (
                                        ...
                                        <td>{moment.tz(trip.docdate, '').format('DD-MM-YYYY')}</td>
                                            ...
                                            <td width="2%">{(trip.optistatus === "Open" || trip.optistatus === "open") ? '' : tConvert(nullAndNanChecking(trip.endTime, 'time'))}</td>
