                                    ...
                                    {trip.lock ?
                                        (this.props.vedetail || []).map((doc, i) => (
                                            <tr class="bg-blue" key={i}>
                                                ...
                                                <td>{moment(doc.arrivedate).format('YYYY-MM-DD')}<br /> <small>{tConvert(doc.arvtime)}</small> </td>
                                                <td>{moment(doc.departdate).format('YYYY-MM-DD')} <br /> <small>{tConvert(doc.departtime)}</small></td>
