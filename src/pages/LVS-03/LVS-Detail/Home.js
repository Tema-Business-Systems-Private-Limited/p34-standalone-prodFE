...
class LVSDetailScreen extends Component {
  ...
  TimeFormatter = (cell, row) => {
   ...
   getlvsstatus = (x) => {
            switch (x) {
                       ...
                       case 3: return ("Loaded  to Truck/Trailer");
                       case 4: return ("Confirmed");
                       case 5: return ("Trip_Completed");
                       case 6: return ("Unloading");
                       case 7: return ("Checked Out");
                       case 8: return ("ALL");
                       case 9: return ("Checked-in");
                       case 10: return ("Checked-Out");
                       case 11: return ("Cancel");
                       case 12: return ("Route In-Progress");
                       case 13: return ("Loading to a Staging");
                       case 14: return ("Loading to Truck/Trailer");
                   }
        }

  getlvsstatusbackground = (x) => {
            switch (x) {
                       case 1: return ("bisque");
                       case 2: return ("bisque");
                       case 3: return ("#fcb92c");
                       case 4: return ("#0B6623");
                       case 5: return ("#0B6623");
                       case 6: return ("lightsalmon");
                       case 7: return ("#28a745");
                       case 8: return ("ALL");
                       case 9: return ("#fcb92c");
                       case 10: return ("#lightsalmon");
                       case 11: return ("#CD5C5C");
                       case 12: return ("#fcb92c");
                       case 13: return ("bisque");
                       case 14: return ("bisque");
                   }
        }
  ...
  render() {
    ...
    console.log("T555 inside lvs header list,", this.props.lvsHeader);
    const routeData = {
    ...
    return (
      ...
      <div className="w-100">
        <Row>
          <Col sm="12">
            <Card style={{color : 'ligthslategray'}}>
            <CardBody>
              <Row className='mt-2'>
                <Col md='4'>
                  <FormGroup row>
                     <Label sm='5'>Source Of Site</Label>
                      <Col sm='7'>
                        <Input type="search" style={{backgroundColor : "#B7F7B7", fontWeight : "bolder"}} placeholder={this.props.lvsHeader.stofcy ? this.props.lvsHeader.stofcy : '' } disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Stock Transaction Number</Label>
                      <Col sm='7'>
                        <Input type="search" placeholder={this.props.lvsHeader.vcrnum} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Status</Label>
                      <Col sm='7'>
                        <Input style={{backgroundColor : this.getlvsstatusbackground(this.props.lvsHeader.xloadflg), fontWeight : "bolder", color : "white"}} type="search" placeholder={this.getlvsstatus(this.props.lvsHeader.xloadflg)} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Trip</Label>
                      <Col sm='7'>
                        <Input type="search" placeholder={this.props.lvsHeader.xtrip} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Carrier</Label>
                      <Col sm='7'>
                        <Input type="search" style={{backgroundColor : "#B7F7B7", fontWeight : "bolder"}} placeholder={this.props.lvsHeader.xbptnum} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Vehicle Code</Label>
                      <Col sm='7'>
                        <Input type="search" style={{backgroundColor : "#B7F7B7", fontWeight : "bolder"}} placeholder={this.props.lvsHeader.xcodeyve} disabled/>
                      </Col>
                  </FormGroup>
                  </Col>
                  <Col md = "4">
                  <FormGroup row>
                     <Label sm='5'>Destination Site</Label>
                      <Col sm='7'>
                        <Input type="search" placeholder={this.props.lvsHeader.xdesfcy} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Loading Date</Label>
                      <Col sm='7'>
                        <Input type="search" placeholder={ moment(this.props.lvsHeader.xxiptdat).format('YYYY-MM-DD')} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Vehicle Routing</Label>
                      <Col sm='7'>
                        <Input type="search" style={{backgroundColor : "#B7F7B7", fontWeight : "bolder"}} placeholder={this.props.lvsHeader.xvrsel} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Date VR</Label>
                      <Col sm='7'>
                        <Input type="search" style={{backgroundColor : "#B7F7B7", fontWeight : "bolder"}} placeholder={moment(this.props.lvsHeader.xvrdate).format('YYYY-MM-DD')} disabled/>
                      </Col>
                  </FormGroup>
                  <FormGroup row>
                     <Label sm='5'>Trailer 1</Label>
                      <Col sm='7'>
                        <Input type="search" placeholder={this.props.lvsHeader.trailer} disabled/>
                      </Col>
                  </FormGroup>
<FormGroup row>
                     <Label sm='5'>Departure Loading Bay</Label>
                      <Col sm='7'>
                        <Input type="search" placeholder={this.props.lvsHeader.xloadbayd} disabled/>
                      </Col>
                  </FormGroup>
                ...
                <Col md = "4">
                                  <FormGroup row>
                                     <Label sm='5'>Scheduled Stock</Label>
                                      <Col sm='7'>
                                        <Input type="checkbox" checked = {this.props.lvsHeader.xbustyp1 === 2 ? true : false} style={{marginLeft : "10px",width : "30px", height : "30px"}}/>
                                      </Col>
                                  </FormGroup>
                                  <FormGroup row>
                                     <Label sm='5'>Spot Sale Stock</Label>
                                      <Col sm='7'>
                                        <Input type="checkbox" checked={this.props.lvsHeader.xbustyp2 === 2 ? true : false} style={{marginLeft : "10px",width : "30px", height : "30px"}}/>
                                      </Col>
                                  </FormGroup>
                                  <FormGroup row>
                                     <Label sm='5'>External Carrier</Label>
                                      <Col sm='7'>
                                        <Input type="checkbox" checked={this.props.lvsHeader.xbustyp2 === 2 ? true : false} style={{marginLeft : "10px",width : "30px", height : "30px"}}/>
                                      </Col>
                                  </FormGroup>
                                  <FormGroup row>
                                     <Label sm='5'>Inventory validation</Label>
                                      <Col >
                                        <Input type="checkbox" checked={this.props.lvsHeader.xstoval === 2 ? true : false} style={{marginLeft : "10px",width : "30px", height : "30px"}}/>
                                      </Col>
                                  </FormGroup>
                                  <FormGroup row>
                                     <Label sm='5'>Trailer 2</Label>
                                      <Col sm='7'>
                                        <Input type="search" placeholder={this.props.lvsHeader.trailer1} disabled/>
                                      </Col>
                                  </FormGroup>
<FormGroup row>
                     <Label sm='5'>Return Loading Bay</Label>
                      <Col sm='7'>
                        <Input type="search" placeholder={this.props.lvsHeader.xloadbayr} disabled/>
                      </Col>
                  </FormGroup>
              ...
              <Row>
                  <Col md = "4">
                                                                      <FormGroup row>
                                                                         <Label sm='5'>Loading the User </Label>
                                                                          <Col sm='7'>
                                                                            <Input type="search" placeholder={this.props.lvsHeader.xloadusr} disabled/>
                                                                          </Col>
                                                                      </FormGroup>
                                                                      <FormGroup row>
                                                                                                                                                                                <Label sm='5'>Manage User Load</Label>
                                                                                                                                                                                 <Col sm='7'>
                                                                                                                                                                                   <Input type="search" placeholder={this.props.lvsHeader.xmlduser} disabled/>
                                                                                                                                                                                 </Col>
                                                                                                                                                                             </FormGroup>
                 ...
                 <Col md = "4">
                                                                     <FormGroup row>
                                                                        <Label sm='5'>Load UserName</Label>
                                                                         <Col sm='7'>
                                                                           <Input type="search" placeholder={this.props.lvsHeader.xloadnam} disabled/>
                                                                         </Col>
                                                                     </FormGroup>
                                                                     <FormGroup row>
                                                                                                          <Label sm='5'>Freight Po#</Label>
                                                                                                           <Col sm='7'>
                                                                                                             <Input type="search" placeholder={this.props.lvsHeader.xpohnum} disabled/>
                                                                                                           </Col>
                                                                                                       </FormGroup>
                 ...
                 <Col md = "4">
                                                                    <FormGroup row>
                                                                       <Label sm='5'>Loading the user email</Label>
                                                                        <Col sm='7'>
                                                                          <Input type="search" placeholder={this.props.lvsHeader.xloademl} disabled/>
                                                                        </Col>
                                                                    </FormGroup>
                                                                    <FormGroup row>
                                                                                                         <Label sm='5'>Status</Label>
                                                                                                          <Col sm='7'>
                                                                                                            <Input type="search" placeholder={this.props.lvsHeader.xstatus} disabled/>
                                                                                                          </Col>
                                                                                                      </FormGroup>
                   ...
                   <Col md='4'>
                     <FormGroup row>
                        <Label sm='4'>Driver ID</Label>
                         <Col sm='8'>
                           <Input type="search" style={{backgroundColor : "#B7F7B7", fontWeight : "bolder"}} placeholder={this.props.lvsHeader.driverid} disabled/>
                         </Col>
                     </FormGroup>
                     <FormGroup row>
                        <Label sm='4'>Sales Man</Label>
                         <Col sm='8'>
                           <Input type="search" placeholder={this.props.lvsHeader.xsalemen} disabled/>
                         </Col>
                     </FormGroup>
                     ...
                     <FormGroup row>
                        <Label sm='4'>Operator</Label>
                         <Col sm='8'>
                           <Input type="search" placeholder={this.props.lvsHeader.xoperator} disabled/>
                         </Col>
                     </FormGroup>
                     <FormGroup row>
                                                                  <Label sm='4'>Device ID</Label>
                                                                   <Col sm='8'>
                                                                     <Input type="search" placeholder={this.props.lvsHeader.xdeviceid} disabled/>
                                                                   </Col>
                                                               </FormGroup>
                      ...
                      <Col md = "4">
                          <FormGroup row>
                                                 <Label sm='4'>Technician</Label>
                                                  <Col sm='8'>
                                                    <Input type="search" placeholder={this.props.lvsHeader.xtechn} disabled/>
                                                  </Col>
                                              </FormGroup>
                       </Col>
                 </Row>
                   ...
                   <Col md='4'>
                     <FormGroup row>
                        <Label sm='5'>Vehicle Weight</Label>
                         <Col sm='7'>
                           <Input type="search" placeholder={this.props.lvsHeader.xcapacities} disabled/>
                         </Col>
                     </FormGroup>
                     <FormGroup row>
                        <Label sm='5'>Vehicle Volume</Label>
                         <Col sm='7'>
                           <Input type="search" placeholder={this.props.lvsHeader.xvehvol} disabled/>
                         </Col>
                     </FormGroup>
                     <FormGroup row>
                        <Label sm='5'>Total Schedule Stock</Label>
                         <Col sm='7'>
                           <Input type="search" placeholder={this.props.lvsHeader.xtotshestk} disabled/>
                         </Col>
                     </FormGroup>
                     <FormGroup row>
                     ...
                     <Col md = "4">
                      ...
                      <FormGroup row>
                                                                 <Label sm='5'>Trailer Volume</Label>
                                                                  <Col sm='7'>
                                                                    <Input type="search" placeholder="480.00" disabled/>
                                                                  </Col>
                                                              </FormGroup>
                        <FormGroup row>
                                              <Label sm='5'>Total Spot Sales Stock</Label>
                                               <Col sm='7'>
                                                 <Input type="search" placeholder={this.props.lvsHeader.xtotnonstk} disabled/>
                                               </Col>
                                           </FormGroup>
                     </Col>
                     <Col md = "4">
                                          <FormGroup row>
                                             <Label sm='5'>Max weight Capacity</Label>
                                              <Col sm='7'>
                                                <Input type="search" placeholder="480.00" disabled/>
                                              </Col>
                                          </FormGroup>
                     ...
                     <FormGroup row>
                                                                                        <Label sm='5'>Total Avaialbe Capacity</Label>
                                                                                         <Col sm='7'>
                                                                                           <Input type="search" placeholder="480.00" disabled/>
                                                                                         </Col>
                                                                                     </FormGroup>
