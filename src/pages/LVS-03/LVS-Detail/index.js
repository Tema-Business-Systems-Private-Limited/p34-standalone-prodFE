...
import LVSDetailScreen from './LVSDetailScreen';
import "../checkIn.scss";

import { fetchLVSHeaderAndDetails } from '../../../service';


class LVSDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      sites: [],
  ...
  componentDidMount() {
    ...
    this.setState({loader : true});
     console.log("passed value is",  this.props.match.params.id)
     const selVR_num = this.props.match.params.id;
                ...
                <Card>
                  <CardBody>
                    <LVSDetailScreen
                      ...
                      lvsHeader = {this.state.lvsHeader}
                      lvsDetails = {this.state.lvsDetails}
