            ...
            if (
              ...
              if (
                ...
                if (prevTripsDist >= props.data.vehicleObject.maxtotaldist) {
                  setDistErrorMessage(
                    `The vehicle cannot perform trip more than ${props.data.vehicleObject.maxtotaldist} Miles, please review trip documents.`
                  );
                  setDistError(true);
...
export default withNamespaces()(Timeline1);
