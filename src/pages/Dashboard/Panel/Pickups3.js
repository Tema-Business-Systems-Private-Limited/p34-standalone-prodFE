...
class Pickups3 extends React.Component {
    ...
    displayPickStatus = (vStatus, x, docnum) => {
        ...
        return (
            <TabPane tabId="Pickups">
                ...
                <div class="reportlist-view tableCustomFixHead">
                    <table class={"table table-sm " + (this.props.trailerDropped ? " " : this.props.dayschecked ? " " : "table-striped m-0")} style={{ height: '200px', display: 'block', overflow: 'auto' }}>
                        ...
                        <thead class="custom-sort" style={{ position: "sticky", top: "0", backgroundColor: "white", zIndex: "9" }}>
                            <tr>
                                ...
                                <th>
                                    {this.props.t('Pickup Address')}
                                </th>
                                <th onClick={() => this.props.sortPickup('bpcode', 1)}>
                                    Client Code{this.props.pickOrder[1] === 1 ? "▼" : "▲"}
                                </th>
                                ...
                                <th onClick={() => this.props.sortPickup('poscode', 4)}>
                                    Postal City {this.props.pickOrder[4] === 1 ? "▼" : "▲"}
                                </th>
                            ...
                            {(pickupList || []).map((pickup, i) => {
                                ...
                                return (
                                    ...
                                    <tr id={'pickup' + pickup.docnum}
                                        className={this.dragStyle(pickup.type, pickup.dlvystatus, pickup.docnum)}
                                        draggable={pickup.type === 'open' && !this.props.selectedDocuments.includes(pickup.docnum) ? "true" : "false"}
                                    ...
                                    >
                                        ...
                                        {this.props.dayschecked &&
                                            <td>{moment.tz(pickup.docdate, '').format('DD-MM-YYYY')}</td>
                                        }
                                        <td>
                                            {pickup.pairedDoc}
                                        </td>
                                        <td>{pickup.doctype && this.displayRouteTag(pickup, lang)}</td>
                                        ...
                                        <td>
                                            ...
                                            <td width="3%">{this.displayPickStatus(pickup.type, pickup.dlvystatus, pickup.docnum)}</td>
                                        </td>
