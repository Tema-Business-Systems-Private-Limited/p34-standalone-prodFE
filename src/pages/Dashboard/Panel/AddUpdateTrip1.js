...
class AddUpdateTrip1 extends React.Component {
        ...
        if (type === "vehicle") {
          ...
          if (trip.code === "") {
            ...
            if (
             ...
             (data.dlvystatus == "8" || data.dlvystatus == "0")
            ) {
  ...
  addDrop = (currentTrip, data, trip) => {
    // console.log("DAta insdie drop", data);
    ...
    if (currentVehicle?.maxordercnt < trip?.stops + 1) {
        ...
        for (var i = 0; i < data.products.length; i++) {
          if (
            ...
            this.setState({
              ...
              currentTrip: trip,
              confirmMessage:
                "Product is not compatability to the customer. Please confirm to exclude all the validations to add document to the trip",
            });
            break;
          }
        }
      ...
      if (data?.vehClassList?.length > 0) {
        ...
        if (veh_vehclass_cus_vehClass_flg) {
          ...
          this.setState({
            ...
            currentTrip: trip,
            confirmMessage:
              "Vehicle Class is not compatability to the customer assigned vehicle class. Please confirm to exclude all the validations to add document to the trip",
          });
        }
      }
    }
              ...
              for (var j = 0; j < data.products.length; j++) {
                if (
                  ...
                  this.setState({
                    ...
                    currentTrip: trip,
                    confirmMessage:
                      "Product  is not compatability to the Trailer assigned to it. Please confirm to exclude all the validations to add document to the trip",
                  });
                  break;
                }
              }
      ...
      if (trip.allcustomers === 2) {
        ...
        if (trip.customerlist && !trip.customerlist.includes(data.bpcode)) {
          ...
          this.setState({
            ...
            currentTrip: trip,
            confirmMessage:
              "Vehicle is not compatability to the customer. Please confirm to exclude all the validations to add document to the trip",
          });
        } else {
          dropCompatability = true;
        }
  ...
  onConfirmClick = (trip) => {
    ...
    console.log(trip.driverId ,"this is driver id 1690")
      ...
      return (
        <table>
          ...
          <tr>
            ...
            <td>
{this.props.selectedTripData.doctype === 'BREAK' ? (
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td width="5%">
                            ...
                            {trip?.vehicleObject?.xmaxtotaldis}
                          </td>
                          <td width="5%">
                            {parseFloat(trip.doc_capacity).toFixed(2)}{" "}
                            {trip?.uom_capacity}
                          </td>
                          <td width="5%">
                            {parseFloat(trip.doc_volume).toFixed(2)}{" "}
                            {trip?.uom_volume}
                          </td>
                          <td width="5%">
                            {trip.doc_qty} {trip.uom_qty}
                          </td>
