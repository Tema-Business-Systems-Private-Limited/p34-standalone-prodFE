...
class VehiclePanel extends React.Component {
  ...
  */
  render() {
    ...
    //       (vehicle.bptnum != null && vehicle.bptnum.toLowerCase().indexOf(this.props.searchVeh.toLowerCase()) !== -1) ||
    //       (vehicle.catego != null && vehicle.catego.toLowerCase().indexOf(this.props.searchVeh.toLowerCase()) !== -1) ||
    //       (vehicle.maxqty != null && vehicle.maxqty.toLowerCase().indexOf(this.props.searchVeh.toLowerCase()) !== -1) ||
    //       (vehicle.capacities != null && vehicle.capacities.toLowerCase().indexOf(this.props.searchVeh.toLowerCase()) !== -1) ||
    //       (vehicle.vol != null && vehicle.vol.toLowerCase().indexOf(this.props.searchVeh.toLowerCase()) !== -1) ||
    //       (vehicle.maxordercnt != null && vehicle.maxordercnt.toLowerCase().indexOf(this.props.searchVeh.toLowerCase()) !== -1) ||
    //       (vehicle.drivername != null && vehicle.drivername.toLowerCase().indexOf(this.props.searchVeh.toLowerCase()) !== -1)
    //     );
    //   }
    // );

    // let filterTrailers = this.props.curVehiclePanel.trails.filter(
    //   (trailer) => {

    //     return ((trailer.trailer.toLowerCase().indexOf(
    //       this.props.searchTra.toLowerCase()
    //     ) !== -1) || (trailer.des.toLowerCase().indexOf(
    //       this.props.searchTra.toLowerCase()
    //     ) !== -1) || (trailer.model.toLowerCase().indexOf(
    //       this.props.searchTra.toLowerCase()
    //     ) !== -1) || (trailer.xmaxlovol.toLowerCase().indexOf(
    //       this.props.searchTra.toLowerCase()
    //     ) !== -1) || (trailer.xmaxloams.toLowerCase().indexOf(
    //       this.props.searchTra.toLowerCase()
    //     ) !== -1));
    ...
    //   (equipment) => {
    //     return ((equipment.xequipid.toLowerCase().indexOf(
    //       this.props.searchEqu.toLowerCase()
    //     ) !== -1) || (equipment.xdescript.toLowerCase().indexOf(
    //       this.props.searchEqu.toLowerCase()
    //     ) !== -1) || (equipment.xequiptyp.toLowerCase().indexOf(
    //       this.props.searchEqu.toLowerCase()
    //     ) !== -1) || (equipment.xcodeyve.toLowerCase().indexOf(
    //       this.props.searchEqu.toLowerCase()
    //     ) !== -1));
    //   }
    // );

    // let filterDriver = this.props.curVehiclePanel.drivers.filter(
    //   (driver) => {
    //     return (
    //     (driver.driver.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1) || 
    //     (driver.driverid.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1) || 
    //     (driver.licenum.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1) || 
    //     (driver.licedat.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1) || 
    //     (driver.cty.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1) || 
    //     (driver.poscod.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1) || 
    //     (driver.cry.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1) ||
    //     (driver.bptnum.toLowerCase().indexOf(this.props.searchDrv.toLowerCase()) !== -1)
    //   );
    //   }
    // );

    // added by ramana on 10-09-2025 for search functionality
    // Vehicles filter
let filterVehicles = this.props.curVehiclePanel?.vehicles?.filter(vehicle => {
  const search = this.props.searchVeh.toLowerCase().trim();
  return [
    vehicle.codeyve,
    vehicle.bptnum,
    vehicle.catego,
    ...
    vehicle.maxordercnt,
    vehicle.drivername
  ].some(field => field != null && String(field).trim() !== "" && String(field).toLowerCase().includes(search));
});

// Trailers filter
let filterTrailers = this.props.curVehiclePanel?.trails?.filter(trailer => {
  const search = this.props.searchTra.toLowerCase();
  return [
    trailer.trailer,
    trailer.des,
    trailer.model,
...
// Equipments filter
let filterEquipments = this.props.curVehiclePanel?.equipments?.filter(equipment => {
  const search = this.props.searchEqu.toLowerCase();
  return [
    equipment.xequipid,
    equipment.xdescript,
    equipment.xequiptyp,
...
let filterDriver = this.props.curVehiclePanel?.drivers?.filter(driver => {
  const search = this.props.searchDrv.toLowerCase().trim();
  return [
    driver.driver,
    driver.driverid,
    driver.licenum,
