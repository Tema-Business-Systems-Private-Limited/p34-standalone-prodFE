    ...
    render() {
        return (
            <TabPane tabId="Drivers">
                ...
                <div class="reportlist-view tableCustomFixHead1" style={{ height: "250px", overflowY: "auto" }}>
                    <table class={this.props.allAllowedDrivers === 2 || this.props.allowedDrivers != '' ? 'table table-hover' : "table table-striped"}>
                      ...
                      zIndex: 1,
                      backgroundColor: "#f8f9fa",
                    }} onClick={() => this.props.sortDriver('cty', 4)}>
                      ...
                      zIndex: 1,
                      backgroundColor: "#f8f9fa",
                    }}>{this.props.t("Lunch Time")} (HH:MM)</th>
                                <th style={{
                      position: "sticky",
                      top: "1px",
                      zIndex: 1,
                      backgroundColor: "#f8f9fa",
                    }}>{this.props.t("Lunch Duration")} (Hrs)</th>
                            </tr>
                        </thead>
                        <tbody>
