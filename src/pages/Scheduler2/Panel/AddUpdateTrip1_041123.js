    ...
    render() {
        ...
        return (
          <Card  class="col-md-12 pt-2 pb-0 pr-1 pl-1"
           ...
           <CardBody>
                                           <div class="col-md-12"  style={{fontSize : "18px",fontWeight : "700", display : "flex", justifyContent : "space-between"}}>
                                              <div> {this.props.t('Route')}   -  {this.props.trips && this.props.trips.length > 0 ? this.props.trips[0].itemCode : actualTrip.routecode} </div>
                                              <div>
                                               <button className="btn " type="button" data-toggle="tooltip" data-placement="top" title="Close"
                                                                                                      onClick={() => this.props.closeActivePanel()} >
                                                                                                      <i class="fa fa-times-circle fa-2x" style={{color : "darkred"}}></i>
                                                                                                  </button>
                                              </div>
                                           </div>
                                        ...
                                        return (
                                            <tr key={i}>
                                              <td className="align-middle">
                                                ...
                                                <td width="5%">{trip.travelTime &&  trip.travelTime === '0' ?  trip.travelTime : trip.travelTime === 'null' ? 0 : trip.travelTime + ' HH:MM'} </td>
                                                <td width="5%">{trip.totalDistance &&  trip.totalDistance === '0' ?  trip.totalDistance : trip.totalDistance === 'null' ? 0 : parseFloat(trip.totalDistance).toFixed(2) +' Miles' }</td>
                                                  <td width="10%">
                                                                                                   <ProgressBar3
                                                ...
                                                <td width="5%">{trip.totalObject && trip.totalObject.selectedTripData && trip.totalObject.selectedTripData.length > 0 ? this.getTotalData(trip.totalObject.selectedTripData , 'w') : 0}</td>
                                                <td width="5%">{trip.totalObject && trip.totalObject.selectedTripData && trip.totalObject.selectedTripData.length > 0 ? this.getTotalData(trip.totalObject.selectedTripData , 'v') : 0}</td>
                                                <td width="5%">{trip.totalObject && trip.totalObject.selectedTripData && trip.totalObject.selectedTripData.length > 0 ? this.getTotalData(trip.totalObject.selectedTripData , 'q') : 0}</td>

                                                <td width="3%"><span class='badge badge-secondary text-uppercase' style={{ fontSize: 14  }} >{trip.pickups} </span></td>
                                                <td width="3%"><span class='badge badge-primary text-uppercase' style={{ fontSize: 14  }} >{trip.drops} </span></td>
                                                <td width="3%"><span class='badge badge-warning text-uppercase' style={{ fontSize: 14  }} >{trip.stops}</span></td>
                                                <td width="3%">
