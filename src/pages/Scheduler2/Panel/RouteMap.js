    ...
    if (this.props.markers !== undefined && this.props.markers.length > 0) {
      ...
      markerArray.map((place) => {
        ...
        if (place.doctype == "PRECEIPT") {
          url =
            "https://mileschemical.mycloudatwork.com/syracuse-main/html/main.html?url=/trans/x3/erp/MILESPILOT/$sessions?f=GESXX10CPTH/2//M/" +
            place.docnum;
          content =
          ...
          url =
            "https://mileschemical.mycloudatwork.com/syracuse-main/html/main.html?url=/trans/x3/erp/MILESPILOT/$sessions?f=GESSDH/2//M/" +
            place.docnum;
          content =
            "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" +
            url +
          ...
          url =
            "https://mileschemical.mycloudatwork.com/syracuse-main/html/main.html?url=/trans/x3/erp/MILESPILOT/$sessions?f=GESPRH2/2//M/" +
            place.docnum;
          content =
            "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" +
            url +
          ...
          url =
            "https://mileschemical.mycloudatwork.com/syracuse-main/html/main.html?url=/trans/x3/erp/MILESPILOT/$sessions?f=GESFCY/2//M/" +
            place.docnum;
          content =
            "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" +
            url +
        ...
        <Card className="mb-3">
          <CardBody className="p-2">
            ...
            >
              ...
              >
                <div>
                  <Button size="small" onClick={this.showList}>
                    {" "}
                    ListView{" "}
                  </Button>{" "}
                </div>
