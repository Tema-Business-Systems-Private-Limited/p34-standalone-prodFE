...
class VrStops3 extends React.Component {
    ...
    render() {
        ...
        */
        ...
        // console.log(this.props.vedetail,"this is vedetail after locking trip")
            ...
            <TabPane tabId="Transactions">
                <Card>
                    <CardTitle className="float-left h4 mb-0 pt-2" style={{ 'color': '#5664d2', 'paddingLeft': '20px' }}>
                        ...
                        <button type="button" class="btn btn-primary btn-sm" style={{ float: "right", marginRight: "15px" }} onClick={this.onDetailList}>{'Detail List'}</button>
                        &nbsp; &nbsp;
                            ...
                            <table className="table table-striped m-0 tablewidth1200" id="dtHorizontalVerticalExample">
                                <thead>
                                    <tr className="">
                                        ...
                                        {/* <th className="mb-0 h6 text-primary">{this.props.t('Comments')}</th> */}
                                    ...
                                    {trip.lock ?
                                        (this.props.vedetail || []).map((doc, i) => (
                                            ...
                                            <tr class="bg-blue" key={i}>
                                                <td ></td>
                                                <td><span className="LS-default">{this.displayBadge(doc.xdoctyp, i + 1)}</span></td>
                                                <td>  {this.GetTiminingWithinRange(i)}</td>
                                        ...
                                        trip.totalObject.selectedTripData.map((doc, i) => {
                                            ...
                                            return (
                                                <tr class="bg-blue" key={i}>
                                                    ...
                                                    <td></td>
                                                    <td>-</td>
                                                    <td>{moment(doc.startDate).format('YYYY-MM-DD')}<br /> <small>{doc.arrival}</small> </td>
                                                    <td>{moment(doc.startDate).format('YYYY-MM-DD')} <br /> <small>{doc.end}</small></td>
