                        ...
                        if (props.data && legs && props.data.stops < results[0].legs.length) {
                            ...
                            if (optimisedTrips.length > 0) {
                                optimisedTrips.map((optiTrip) => {
                                    if (optiTrip.code === props.data.code && optiTrip.docdate === props.data.docdate) {
                            ...
                            let previousCheck = [];
                            props.tripsPanel.map((tripPanel) => {
                                if (tripPanel.code === props.data.code && tripPanel.docdate === props.data.docdate) {
                                    if (tripPanel.trips === props.data.trips - 1) {
                  ...
                  <CardBody className="p-0">
                    ...
                    <div className="table-responsive">
                      <Table className="mb-0">
                        <tbody>
                          <tr>
                            <th     ><img src={truck_dep} alt="" height="48" /></th>
                            <td>{moment.tz(props.data.docdate,'').format('YYYY-MM-DD')}</td>
                                                        ...
                                                        <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                                                                            <TimePicker
                                                                                                InputProps={{
                                                                                                    ...
                                                                                                    style: { fontWeight: 'bold', color: 'blue', fontSize: '13px', width: '35px' }
                                                                                                }}
                                                                                                clearable
                                                                                                ampm={false}
                                                                                                value={selectedDate}
                                       ...
                                       <th scope="row">{props.t('Duration')}</th>
                                                                                      <td>{props.data.optistatus === "Open" ? '' :
                                                                                                                              (props.data.totalTime) ? nullAndTime(props.data.totalTime) +' HH:MM' : ' '}</td>
                          ...
                          <tr>
                             <th scope="row"><img src={truck_arr} alt="" height="48" /></th>
                            <td>{getEndDate()}</td>
                ...
                <DisplayInformationIconDetails
                 ...
                 {(() => {
                                        if (props.data.tmsValidated) {
                                            ...
                                            return (
                                                <button type="button" class="btn btn-primary btn-sm mt-2" style={{ fontSize: '12px', fontWeight: 'bold', marginRight: '3%', width : "max-content", alignSelf : "flex-end" }}
