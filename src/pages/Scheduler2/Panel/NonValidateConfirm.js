...
class NonValidateConfirm extends React.Component {
    render() {
        return (
            <Modal
            {...this.props}
            ...
            <>
                {this.props.lock ?'' : <Button className='button-custom' onClick={() => this.props.validateConfirm(this.props.index)} >Yes</Button>}
...
export default NonValidateConfirm;