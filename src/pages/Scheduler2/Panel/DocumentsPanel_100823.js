...
toggleTab(tab) {
 ...
 if(this.props.dropsPanel){
            ...
            filterDrops = filterDrops.filter(
             ...
             if(site === ""){
                                  return ((drop.docnum.toLowerCase().indexOf(
                                                          ...
                                                          this.props.searchDrp.toLowerCase()
                                                      ) !== -1) || (drop.city.toLowerCase().indexOf(
                                                          this.props.searchDrp.toLowerCase()
                                                      ) !== -1));
   ...
   let ValidatedTripsCount = 0;
     ...
     this.props.tripsList && this.props.tripsList.map((trip, k) => {
   ...
   this.props.dropsPanel && this.props.dropsPanel.map((drop , i) => {

      // To plan count
      if((drop.type === 'open') && (drop.dlvystatus === '0' || drop.dlvystatus === '8')) {
                ...
                <div className="d-flex justify-content-between align-items-center">
                             <Nav tabs className="nav-tabs-custom nav-justified">
                                                           <NavItem>
                                                             ...
                                                             >
                                                               <span style={{fontWeight : "bolder", fontSize: "large"}}>{this.props.t('Documents')}[{filterDrops.length}]</span>
                                                             </NavLink>
                                                           </NavItem>
                                                           <NavItem>
                                                              <NavLink
                                                                                                                        ...
                                                                                                                        >
                                                                                                                          <span style={{fontWeight : "bolder", fontSize: "large"}}>{this.props.t('Trips')}[{filterTrips.length}]</span>
                                                                                                                        </NavLink>
                                                                                                                      </NavItem>
                                                          <NavItem>
                                                                                                                        <NavLink
                                                                                                                                                                                    style={{ cursor: "pointer" }}
                                                                                                                                                                                    className={classnames({
                                                                                                                                                                                      active: this.state.activeTab === "ListView",
                                                                                                                                                                                    })}
                                                                                                                                                                                    onClick={() => {
                                                                                                                                                                                      this.toggleTab("ListView");
                                                                                                                                                                                    }}
                                                                                                                                                                                  >
                                                                                                                                                                                    <span style={{fontWeight : "bolder", fontSize: "large"}}>{this.props.t('ListView')}</span>
                                                                                                                                                                                  </NavLink>
                                                                                                                                                                                </NavItem>
                                                         </Nav>
                             ...
                             <div className="custom-control custom-checkbox mb-2 mr-3" style={{fontWeight : "bolder", fontSize: "large"}}>
                                                              <Input
                                                                type="checkbox"
