...
//       <InputLabel id="demo-mutiple-chip-label">Vehicles</InputLabel>
//       <Select
...
// export default MultiVehicleCode;
...
function MultiVehicleCode(props) {
  ...
  useEffect(()=>{
    if(!selected){
      const addVehicleCodes= props.options.map((option) => option.value);
      props.setSelectedVehicleCodes(addVehicleCodes.toString());
      props.selectedVehicleCodeArr(addVehicleCodes);
    }
  },[selected])
  return (
    <Select
