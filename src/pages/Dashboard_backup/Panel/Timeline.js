...
function Timeline(props) {
    ...
    const optimizeRoute = (data) => {
        console.log("T2222 inside optimize route")
        setLoader(true);
        let siteLat;
        let siteLang;
        let arrSiteLat;
        ...
        return fetch(url)
            .then(function (response) {
                ...
                if (summaryResult && summaryResult.summarydata && summaryResult.serviceTime && summaryResult.waitingTime) {
                    ...
                    console.log("T2222 summary data", summaryData)
                    console.log("T2222 service time", serviceTime)
                    console.log("T2222 waiting time", waitingTime)
                    if (results) {
                        ...
                        if (props.data && legs && props.data.stops < results[0].legs.length) {
                            ...
                            if (sameTrips.length > 0) {
                                console.log("T2222 same trip if");
                                let sameTripTime = []
                            ...
                            console.log("T2222 same after same trip if");
                            ...
                            legs.forEach((data, index) => {
                                ...
                                console.log("T2222 end time", res.end);
                                console.log("T2222 arrival time", res.arrival);
                                res.startDate = prevDate;
                                res.endDate = prevDate
                                let latestEndDate = prevDate
                                let latestStartDate = prevDate
                                console.log("T2222 1 STart DAte ", latestStartDate);
                                console.log("T2222 1 end Date", latestEndDate);
                                //   let curtime = tTime.split(':');
                                 ...
                                 */
                                console.log("T2222 2 Final for doc Start DAte ", latestStartDate);
                                console.log("T2222 2 Final for doc end Date", latestEndDate);
                                ...
                                console.log("T2222 2 prev DAte ", prevDate);
                                console.log("T2222 2 prev doc time", prevDocTime);
                                console.log("final document updates are", res);
                            ...
                            prevTripsTime = prevTripsTime + totTimeSec;
                            let maxTotTimeSec = convertHrToSec(Number(props.data.vehicleObject.maxtotaltime));
                            console.log("T3334 at optimisation tot max time =", maxTotTimeSec);
                            console.log("T3334 at optimisation prev time =", prevTripsTime);
                            console.log("T3334 at optimisation prev dist =", prevTripsDist);
                            if (prevTripsDist >= props.data.vehicleObject.maxtotaldist
                                ...
                                console.log("T2222 at last endTime", endTime);
                                console.log("T2222 at last StartTime", startTimeLocal);
                                console.log("T2222 at last Trip Total time", formatTime(tripData.tripTotalTime));
                                ...
                                console.log("T5151 inside timeline- RouteSchedule", routesSchedule);
                                console.log("T5151 inside timeline- optiindex", optiindex);
                                console.log("T5151 inside timeline- autooptimise", autooptimise)
                        ...
                        <Table className="mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{props && props.date && props.data && props.data.optistatus === "Optimized" && props.date}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{props.data.optistatus === "Open" ? '' :
                                        tConvert(props.data.endTime) ? tConvert(nullAndNanChecking(props.data.endTime, 'time')) : ''}</td>
                                </tr>
                                <tr>
