                            ...
                            <DropdownMenu className="dropdown-megamenu">
                                <Row>
                                    <Col sm={8}>
                                        ...
                                        <Row>
                                            <Col md={4}>
                                                <h5 className="font-size-14 mt-0">{this.props.t('Route Planning')}</h5>
                                            ...
                                            <Col md={4}>
                                                <h5 className="font-size-14 mt-0">{this.props.t('Reports')}</h5>
                                                <ul className="list-unstyled megamenu-list">
                                                    <li>
                                            ...
                                            <Col md={4}>
                                                <h5 className="font-size-14 mt-0">{this.props.t('Fleet Management')}</h5>
                                                <ul className="list-unstyled megamenu-list">
                                                    <li>
